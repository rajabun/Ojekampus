...
public class OjeKampus
{
    ...
    Lokasi kang_ojek = new Lokasi("Taman Kota 2", 3, 2, "BSD");
    //Ojek ojek_Muhammad = new Ojek(1,"Muhammad",kang_ojek); //membuat objek baru pada kelas Ojek dengan nama ojek_muhammad. Ojek("Muhammad") merupakan implementasi dari constructor Ojek(String nama)
    Ojek ojek_Muhammad = new Ojek(1,"Muhammad"); //membuat objek baru pada kelas Ojek dengan nama ojek_muhammad. Ojek("Muhammad") merupakan implementasi dari constructor Ojek(String nama)
    ...
    */
    ...
    public static void main (String [] args) throws Exception
    {
        ...
        Lokasi kang_ojek = new Lokasi("Taman Kota 2", 3, 2, "BSD");
        Ojek ojek_Muhammad = new Ojek(1,"Muhammad", kang_ojek); //membuat objek baru pada kelas Ojek dengan nama ojek_muhammad. Ojek("Muhammad") merupakan implementasi dari constructor Ojek(String nama)
        Ojek ojek_Muhammad_2 = new Ojek(2,"Shion", kang_ojek); //membuat objek baru pada kelas Ojek dengan nama ojek_muhammad. Ojek("Muhammad") merupakan implementasi dari constructor Ojek(String nama)
        Ojek ojek_Muhammad_3 = new Ojek(3,"Jabun", kang_ojek); //membuat objek baru pada kelas Ojek dengan nama ojek_muhammad. Ojek("Muhammad") merupakan implementasi dari constructor Ojek(String nama)
        Pelanggan p_Rajab = new Pelanggan(DatabaseUser.getIDPelangganTerakhir(),"Rajab","085854032720"); //membuat objek baru pada kelas Pelanggan
        Pelanggan p_Rajab_2 = new Pelanggan(DatabaseUser.getIDPelangganTerakhir(), "Priharsanto","081234567890"); //membuat objek baru pada kelas Pelanggan
        Pelanggan p_Rajab_3 = new Pelanggan(DatabaseUser.getIDPelangganTerakhir(),"Ani","081311242868"); //membuat objek baru pada kelas Pelanggan
        Lokasi per_Rajab_awal = new Lokasi("Taman Menteng", 2, 4, "Bintaro"); //membuat objek baru pada kelas Lokasi
        Lokasi per_Rajab_akhir = new Lokasi("Taman Kota", 4, 4, "BSD"); //membuat objek baru pada kelas Lokasi
        Pesanan pes_Rajab = new Pesanan(p_Rajab, TipeLayanan.AntarBarang, per_Rajab_awal, per_Rajab_akhir, "Fakhri", "Ivan", 100000); //membuat objek baru pada kelas Pesanan
        Pesanan pes_Rajab_2 = new Pesanan(p_Rajab_2, TipeLayanan.BeliBarang, per_Rajab_akhir, per_Rajab_awal, "Fatayati", "Illiyuni", 50000); //membuat objek baru pada kelas Pesanan
        Pesanan pes_Rajab_3 = new Pesanan(p_Rajab_3, TipeLayanan.AntarOrang, per_Rajab_awal, per_Rajab_akhir, "Jos", "Gandos", 25000); //membuat objek baru pada kelas Pesanan
        //Pesanan pes_Rajab_4 = new Pesanan(p_Rajab, TipeLayanan.AntarOrang, per_Rajab_awal, per_Rajab_akhir, "Jos", "Gandos", 25000); //membuat objek baru pada kelas Pesanan
        DatabaseUser.addOjek(ojek_Muhammad);
        DatabaseUser.addOjek(ojek_Muhammad_2);
        DatabaseUser.addOjek(ojek_Muhammad_3);
        DatabaseUser.addOjek(ojek_Muhammad);
        DatabaseUser.addPelanggan(p_Rajab);
        DatabaseUser.addPelanggan(p_Rajab_2);
        //DatabaseUser.addPelanggan(p_Rajab_3);
        DatabaseUser.addPelanggan(p_Rajab);
        pes_Rajab.setPelayan(ojek_Muhammad);
        */
        //ojek_Muhammad.getPesanan();
        //DatabaseUser.removeOjek(1);
        //DatabaseUser.removeOjek(1);
        //DatabaseUser.removeOjek(2);
        //DatabaseUser.removeOjek(2);
        //DatabaseUser.removeOjek(3);
        //DatabaseUser.removeOjek(3);
        //DatabaseUser.removePelanggan(1);
        //DatabaseUser.removePelanggan(1);
        //DatabaseUser.removePelanggan(2);
        //DatabaseUser.removePelanggan(2);
        //DatabaseUser.removePelanggan(3);
        //DatabaseUser.removePelanggan(3);
        //System.out.println(DatabaseUser.getPelangganDatabase());
        //DatabaseUser.getOjekDatabase();
        //DatabaseUser.getUserOjek(1);
        //DatabaseUser.getUserPelanggan(1);
        //DatabaseUser.getOjekDatabase();
        //DatabasePesanan.addPesanan(pes_Rajab);
        //DatabasePesanan.hapusPesanan(pes_Rajab);
        CustomerGUI c = new CustomerGUI();
        c.main(new String[0]);
        OjekGUI g = new OjekGUI();
        g.main(new String[0]);
        
        //DatabasePesanan.addPesanan(pes_Rajab);
        //DatabasePesanan.hapusPesanan(p_Rajab);
        //DatabasePesanan.addPesanan(pes_Rajab_2);
        //DatabasePesanan.addPesanan(pes_Rajab_3);
        //Administrasi.jalankanSistemPenugas();
        //DatabasePesanan.getPesanan(p_Rajab_2);
        //DatabasePesanan.getPesanan(p_Rajab);
        //DatabasePesanan.addPesanan(pes_Rajab_4);
        //menungguSistem(10);
    }
