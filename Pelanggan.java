...
public class Pelanggan extends User
{
    ...
    public Pelanggan(int id, String nama, String telepon) 
    {
        ...
        super(id, nama);
        setTelepon(telepon);
        setStatusUser(StatusUser.Pelanggan);
    }
    ...
    {
        for (int i = 1; i < DatabaseUser.getPelangganDatabase().size(); i++)
        {
            //if(DatabasePesanan.getPesanan() == null)
            //if(DatabasePesanan.getPesanan(DatabasePesanan.getDatabase().get(i).getPelanggan()) == null)
            Pelanggan p = DatabaseUser.getPelangganDatabase().get(i);
            if(DatabasePesanan.getDatabase().isEmpty())
            {
                ...
                System.out.println("ID Pelanggan :" + " " + getID());
                System.out.println("Nomor Telepon :" + " " + getTelepon() + "\n");

            }
            //else if(DatabasePesanan.getPesanan() != null)
            //else if(DatabasePesanan.getPesanan(DatabasePesanan.getDatabase().get(i).getPelanggan()) != null)
            else //if(DatabasePesanan.getDatabase().isEmpty())
            {
                /*
                System.out.println("Nama Pelanggan:" + " " + nama);
                System.out.println("ID Pelanggan :" + " " + getID());
                System.out.println("Nomor Telepon :" + " " + telepon);
                System.out.println("Nama Pengirim : " + DatabasePesanan.getPesanan(DatabasePesanan.getDatabase().get(i).getPelanggan()).getPelanggan().getNama() + "\n");
                getNama();
                getID();
                DatabasePesanan.getPesanan(DatabasePesanan.getDatabase().get(i).getPelanggan()).getPelanggan();
                //return telefon;
                 */
                System.out.println("Nama Pelanggan:" + " " + getNama());
                System.out.println("ID Pelanggan :" + " " + getID());
                System.out.println("Nomor Telepon :" + " " + getTelepon());
                //System.out.println("Nama Pengirim : " + DatabasePesanan.getPesanan(p).getPelanggan().getNama() + "\n");                
            }
        }
        return "";
    }
